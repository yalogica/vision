...
<div class="vision-root" id="vision-app-item" style="display:none;">
	...
	<div class="vision-page-header">
		<div class="vision-title"><?php esc_html_e('Vision Item', 'vision'); ?></div>
		<div class="vision-actions">
			...
			<a class="vision-indigo" href="#" al-on.click="appData.fn.saveConfigToFile(appData)" title="<?php esc_html_e('Save config to a JSON file', 'vision'); ?>"><?php esc_html_e('Save As...', 'vision'); ?></a>
			<a class="vision-green" href="#" al-on.click="appData.fn.loadConfigFromFile(appData)" title="<?php esc_html_e('Load config from a JSON file', 'vision'); ?>"><?php esc_html_e('Load As...', 'vision'); ?></a>
		</div>
	</div>
		...
		<div class="vision-wrap">
			...
			<div class="vision-workplace">
				<div class="vision-main-menu">
					<div class="vision-left-panel">
						<div class="vision-list">
							...
							<a class="vision-item vision-small vision-pro" href="https://1.envato.market/getvision" target="_blank" al-if="appData.plan=='pro'"><?php esc_html_e('Pro Version', 'vision'); ?></a>
						</div>
					</div>
				...
				<div class="vision-main-tabs vision-clear-fix">
					<div class="vision-tab" al-attr.class.vision-active="appData.ui.tabs.general" al-on.click="appData.fn.onTab(appData, 'general')"><?php esc_html_e('General', 'vision'); ?><div class="vision-status" al-if="appData.config.active"></div></div>
					<div class="vision-tab" al-attr.class.vision-active="appData.ui.tabs.layers" al-on.click="appData.fn.onTab(appData, 'layers')"><?php esc_html_e('Layers', 'vision'); ?></div>
								...
								<div class="vision-data vision-active">
									<div class="vision-block" al-attr.class.vision-block-folded="appData.ui.generalTab.main">
										<div class="vision-block-header" al-on.click="appData.fn.onGeneralTab(appData,'main')">
											<div class="vision-block-title"><?php esc_html_e('Main settings', 'vision'); ?></div>
										...
										<div class="vision-block-data">
											...
											<div class="vision-control">
												<div class="vision-helper" title="<?php esc_html_e('Sets a main map image (jpeg or png format)', 'vision'); ?>"></div>
												...
												<div class="vision-input-group">
													...
													<div class="vision-input-group-cell vision-pinch">
														<div class="vision-btn vision-default vision-no-bl" al-on.click="appData.fn.selectImage(appData, appData.rootScope, appData.config.image)" title="<?php esc_html_e('Select an image', 'vision'); ?>"><span><i class="fa fa-folder"></i></span></div>
													</div>
												</div>
											</div>
										...
										<div class="vision-block-data">
											...
											<div class="vision-control">
												...
												<div class="vision-input-group">
													...
													<div class="vision-input-group-cell vision-pinch">
														<div class="vision-btn vision-default vision-no-bl" al-on.click="appData.fn.selectImage(appData, appData.rootScope, appData.config.background.image)" title="<?php esc_html_e('Select a background image', 'vision'); ?>"><span><i class="fa fa-folder"></i></span></div>
													</div>
												</div>
											</div>
						...
						<div class="vision-stage">
							<div class="vision-main-panel">
								<div class="vision-edit-layers">
									<div class="vision-layers-toolbar-navigation" al-if="appData.config.layers.length > 0">
										<i class="fa fa-chevron-left" al-on.click="appData.fn.prevLayer(appData)" title="<?php esc_html_e('Prev layer', 'vision'); ?>"></i>
										<i class="fa fa-chevron-right" al-on.click="appData.fn.nextLayer(appData)" title="<?php esc_html_e('Next layer', 'vision'); ?>"></i>
									</div>
									<div class="vision-layers-toolbar-view">
										<i class="fa fa-search-plus" al-on.click="appData.fn.canvasZoomIn(appData)" title="<?php esc_html_e('Zoom in', 'vision'); ?>"></i>
										<span class="vision-zoom-value">{{appData.fn.getCanvasZoom(appData)}}%</span>
										<i class="fa fa-search-minus" al-on.click="appData.fn.canvasZoomOut(appData)" title="<?php esc_html_e('Zoom out', 'vision'); ?>"></i>
										<i class="fa fa-search" al-on.click="appData.fn.canvasZoomDefault(appData)" title="<?php esc_html_e('Zoom default', 'vision'); ?>"></i>
										<i class="fa fa-arrows" al-on.click="appData.fn.canvasZoomFit(appData)" title="<?php esc_html_e('Zoom fit', 'vision'); ?>"></i>
										<i class="fa fa-dot-circle-o" al-on.click="appData.fn.canvasMoveDefault(appData)" title="<?php esc_html_e('Move default', 'vision'); ?>"></i>
									</div>
							...
							<div class="vision-sidebar-panel" al-attr.class.vision-hidden="!appData.ui.sidebar" al-style.width="appData.ui.sidebarWidth">
								...
								<div class="vision-tabs vision-clear-fix">
									<div class="vision-tab" al-attr.class.vision-active="appData.ui.layersTabs.layers" al-on.click="appData.fn.onLayersTab(appData, 'layers')"><?php esc_html_e('Layers', 'vision'); ?></div>
									<div class="vision-tab" al-attr.class.vision-active="appData.ui.layersTabs.layer" al-on.click="appData.fn.onLayersTab(appData, 'layer')"><?php esc_html_e('Layer', 'vision'); ?></div>
									<div class="vision-tab" al-attr.class.vision-active="appData.ui.layersTabs.tooltip" al-on.click="appData.fn.onLayersTab(appData, 'tooltip')"><?php esc_html_e('Tooltip', 'vision'); ?><div class="vision-status" al-if="appData.ui.activeLayer != null && appData.ui.activeLayer.tooltip.active"></div></div>
									<div class="vision-tab" al-attr.class.vision-active="appData.ui.layersTabs.popover" al-on.click="appData.fn.onLayersTab(appData, 'popover')"><?php esc_html_e('Popover', 'vision'); ?><div class="vision-status" al-if="appData.ui.activeLayer != null && appData.ui.activeLayer.popover.active"></div></div>
								</div>
								<div class="vision-data" al-attr.class.vision-active="appData.ui.layersTabs.layers">
									<div class="vision-layers-wrap">
										<div class="vision-layers-toolbar">
											<div class="vision-left-panel">
												<i class="fa fa-external-link" al-on.click="appData.fn.addLayerLink(appData)" title="<?php esc_html_e('add link', 'vision'); ?>"></i>
												<i class="fa fa-font" al-on.click="appData.fn.addLayerText(appData)" title="<?php esc_html_e('add text', 'vision'); ?>"></i>
												<i class="fa fa-picture-o" al-on.click="appData.fn.addLayerImage(appData)" title="<?php esc_html_e('add image', 'vision'); ?>"></i>
												<!--<i class="fa fa-object-ungroup" al-on.click="appData.fn.addLayerSVG(appData)" title="<?php esc_html_e('add svg', 'vision'); ?>"></i>-->
												<span al-if="appData.ui.activeLayer != null">
												<i class="vision-separator"></i>
												<i class="fa fa-clone" al-on.click="appData.fn.copyLayer(appData)" title="<?php esc_html_e('copy', 'vision'); ?>"></i>
												<i class="fa fa-arrow-up" al-on.click="appData.fn.updownLayer(appData, 'up')" title="<?php esc_html_e('move up', 'vision'); ?>"></i>
												<i class="fa fa-arrow-down" al-on.click="appData.fn.updownLayer(appData, 'down')" title="<?php esc_html_e('move down', 'vision'); ?>"></i>
												</span>
											</div>
											<div class="vision-right-panel">
												<i class="fa fa-trash-o fa-color-red" al-if="appData.ui.activeLayer != null" al-on.click="appData.fn.deleteLayer(appData)" title="<?php esc_html_e('delete', 'vision'); ?>"></i>
											</div>
										</div>
										<div class="vision-layers-list">
											<div class="vision-layer"
											 ...
											 >
												...
												<div class="vision-actions">
													<i class="fa fa-commenting-o" al-attr.class.vision-inactive="!layer.tooltip.active" al-on.click="appData.fn.toggleLayerTooltip(appData, layer)" title="<?php esc_html_e('enable/disable tooltip', 'vision'); ?>"></i>
													<i class="fa fa-address-card-o" al-attr.class.vision-inactive="!layer.popover.active" al-on.click="appData.fn.toggleLayerPopover(appData, layer)" title="<?php esc_html_e('enable/disable popover', 'vision'); ?>"></i>
													<i class="fa" al-attr.class.fa-toggle-on="layer.visible" al-attr.class.fa-toggle-off="!layer.visible" al-on.click="appData.fn.toggleLayerVisible(appData, layer)" title="<?php esc_html_e('show/hide', 'vision'); ?>"></i>
													<i class="fa" al-attr.class.fa-unlock-alt="!layer.lock" al-attr.class.fa-lock="layer.lock" al-on.click="appData.fn.toggleLayerLock(appData, layer)" title="<?php esc_html_e('lock/unlock', 'vision'); ?>"></i>
												</div>
											</div>
										</div>
									</div>
												...
												<div class="vision-block-data">
													...
													<div class="vision-control">
														...
														<div class="vision-input-group vision-long">
															...
															<div class="vision-input-group-cell vision-pinch">
																<div class="vision-btn vision-default vision-no-bl" al-on.click="appData.fn.generateLayerId(appData, appData.rootScope, appData.ui.activeLayer)" title="<?php esc_html_e('Generate a new ID', 'vision'); ?>"><span><i class="fa fa-refresh"></i></span></div>
															</div>
														</div>
													</div>
											...
											<div class="vision-block" al-attr.class.vision-block-folded="appData.ui.layerTab.data">
												...
												<div class="vision-block-data">
													<div class="vision-control">
														...
														<div class="vision-input-group vision-long">
                                                            <div class="vision-input-group-cell">
															    <input class="vision-text vision-long vision-no-brr" type="text" al-text="appData.ui.activeLayer.url" placeholder="<?php esc_html_e('URL', 'vision'); ?>">
                                                            </div>
                                                            <div class="vision-input-group-cell vision-pinch">
                                                                <div class="vision-btn vision-default vision-no-bl" al-on.click="appData.fn.getPostUrl(appData, appData.rootScope, appData.ui.activeLayer)" title="<?php esc_html_e('Get a post url', 'vision'); ?>"><span><i class="fa fa-file"></i></span></div>
                                                            </div>
														</div>
														<div class="vision-input-group vision-long">
															<div class="vision-input-group-cell vision-pinch">
														...
														<div class="vision-input-group vision-long">
															<div class="vision-input-group-cell vision-rgap">
																...
																<div class="vision-input-group vision-long">
																	...
																	<div class="vision-input-group-cell vision-pinch">
																		<div class="vision-btn vision-default vision-no-bl" al-on.click="appData.fn.selectShowAnimation(appData, appData.ui.activeLayer.tooltip)" title="<?php esc_html_e('Select an effect', 'vision'); ?>"><span><i class="fa fa-folder"></i></span></div>
																	</div>
																</div>
																</div>
															<div class="vision-input-group-cell vision-lgap">
																...
																<div class="vision-input-group vision-long">
																	...
																	<div class="vision-input-group-cell vision-pinch">
																		<div class="vision-btn vision-default vision-no-bl" al-on.click="appData.fn.selectHideAnimation(appData, appData.ui.activeLayer.tooltip)" title="<?php esc_html_e('Select an effect', 'vision'); ?>"><span><i class="fa fa-folder"></i></span></div>
																	</div>
																</div>
															</div>
														</div>
							...
							<div class="vision-data vision-active">
								...
								<div class="vision-control">
									...
									<div class="vision-input-group">
										...
										<div class="vision-input-group-cell vision-pinch">
											<div class="vision-btn vision-default vision-no-bl" al-on.click="appData.fn.copyToClipboard(appData, '#vision-shortcode-1')" title="<?php esc_html_e('Copy to clipboard', 'vision'); ?>"><span><i class="fa fa-clipboard"></i></span></div>
										</div>
									</div>
								</div>
